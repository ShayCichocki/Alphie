...
func (db *DB) ListItems(project string, status *Status) ([]Item, error) {
...
func (db *DB) ReadyItems(project string) ([]Item, error) {
...
type StatusReport struct {
	...
	Canceled     int
	Ready        int
	RecentDone   []Item // last 3 completed
	InProgItems  []Item // current in-progress
	BlockedItems []Item // blocked with reasons
	ReadyItems   []Item // ready for work
}
