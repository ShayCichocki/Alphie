...
func TestListItems(t *testing.T) {
	...
	createTestItemWithProject(t, db, "Task 1", "proj1", StatusOpen, 2)
	createTestItemWithProject(t, db, "Task 2", "proj1", StatusDone, 2)
	createTestItemWithProject(t, db, "Task 3", "proj2", StatusOpen, 2)
...
func TestListItems_OrderByPriority(t *testing.T) {
	...
	createTestItemWithProject(t, db, "Low", "test", StatusOpen, 3)
	createTestItemWithProject(t, db, "High", "test", StatusOpen, 1)
	createTestItemWithProject(t, db, "Medium", "test", StatusOpen, 2)
...
func TestReadyItems(t *testing.T) {
	...
	task1 := createTestItemWithProject(t, db, "Task 1", "test", StatusOpen, 2)
	task2 := createTestItemWithProject(t, db, "Task 2", "test", StatusOpen, 2)
	createTestItemWithProject(t, db, "Task 3", "test", StatusInProgress, 2) // not ready (in_progress)
	...
	if err := db.UpdateStatus(task1.ID, StatusDone); err != nil {
...
func TestReadyItems_ProjectFilter(t *testing.T) {
	...
	createTestItemWithProject(t, db, "Task 1", "proj1", StatusOpen, 2)
	createTestItemWithProject(t, db, "Task 2", "proj2", StatusOpen, 2)
...
func TestProjectStatus(t *testing.T) {
	...
	createTestItemWithProject(t, db, "Open 1", "test", StatusOpen, 2)
	createTestItemWithProject(t, db, "Open 2", "test", StatusOpen, 1)
	createTestItemWithProject(t, db, "In Progress", "test", StatusInProgress, 2)
	createTestItemWithProject(t, db, "Blocked", "test", StatusBlocked, 2)
	createTestItemWithProject(t, db, "Done", "test", StatusDone, 2)
...
func createTestEpic(t *testing.T, db *DB, title, project string) *Item {
	t.Helper()
	item := &Item{
...
func TestListItemsFiltered_Type(t *testing.T) {
	...
	createTestItemWithProject(t, db, "Task 1", "test", StatusOpen, 2)
	createTestItemWithProject(t, db, "Task 2", "test", StatusOpen, 2)
...
func TestListItemsFiltered_Blocking(t *testing.T) {
	...
	task1 := createTestItemWithProject(t, db, "Task 1", "test", StatusOpen, 2)
	task2 := createTestItemWithProject(t, db, "Task 2", "test", StatusOpen, 2)
	task3 := createTestItemWithProject(t, db, "Task 3", "test", StatusOpen, 2)
...
func TestListItemsFiltered_CombinedFilters(t *testing.T) {
	...
	task1 := createTestItemWithProject(t, db, "Task 1", "test", StatusOpen, 2)
	task2 := createTestItemWithProject(t, db, "Task 2", "test", StatusDone, 2)
	task3 := createTestItemWithProject(t, db, "Task 3", "other", StatusOpen, 2)
